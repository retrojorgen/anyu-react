  ...
  fields: [
    {
      ...
      fields: [
        ...
        {name: 'facebookButtonText', type: 'url', title: 'Facebook booking knapp tittel'},
        { name: 'phoneNumberBooking', type: 'string', title: 'Telefonnummer til booking' },
        {name: 'phoneNumberBookingText', type: 'string', title: 'Tekst til telefonnummer booking-knapp'},
      ],
    },
    {
      ...
      of: [
        {
          type: 'object', fields: [
            ...
            { name: 'photo', type: 'image', title: 'Bilde', hidden: ({ parent }: { parent: { displaytype: string } }) => parent.displaytype === "youtubeRight" },
            { name: 'youtubeID', type: 'string', title: 'YouTube video ID', hidden: ({ parent }: { parent: {displaytype : string} }) => parent.displaytype !== "youtubeRight"},
            {
              title: 'Tekst',
              name: 'content',
              type: 'array',
