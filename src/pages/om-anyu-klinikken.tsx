  ...
  return (
    <>
      ...
      <blockquote>Livskraft i flyt og balanse gir god fysisk og mental helse.</blockquote>
        ...
        <p>Ring oss på tlf: 406 70 885, eller send mail til&nbsp;<a href="mailto:post@anyu.no" target="_blank" rel="noopener">post@anyu.no</a></p>
        <h2>Vår behandler</h2>
        <img src={photo4.src} className={styles.fullimage} />
        <h3>Ildiko Balog</h3>
        <p>TLF: <a href="tel:40670885">40670885</a></p>
