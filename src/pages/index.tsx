    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <FrontBlockRightImage>
          ...
          <Image className="right-content" src={photo1} alt="Akupunktur" loading='lazy' />
        </FrontBlockRightImage>
        ...
        <FrontBlockRightImage>
          ...
          <Image className="right-content" src={photo2} alt="Akupunktur" loading='lazy' />
        </FrontBlockRightImage>
        <FrontBlocBackgroundImage backgroundImage={photo4.src}>
          <div className="left-content">
            ...
            <p>Lurer du på om vi kan hjelpe deg med din plage? Ta kontakt på tlf 40670885, eller send en melding på vår <a aria-label="facebookside" href="https://www.facebook.com/anyuklinikken/">facebook-side</a>.</p>
          </div>
        </FrontBlocBackgroundImage>
        <FrontBlockRightImage>
          <div className="left-content">
          ...
          <div className="right-content">
            <LiteYouTubeEmbed id="jUNaTrBznDY" title="Anyu video"></LiteYouTubeEmbed>
          </div>
        </FrontBlockRightImage>
      </main>
    </>
